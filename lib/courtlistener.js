...
export function mapCourtListenerResult(result) {
  ...
  const sides = splitCaseSides(result.caseName || result.caseNameShort || title);
  ...
  return {
    ...
    sourceDetails: {
      ...
      court: result.court || "",
      courtCitationString: result.court_citation_string || "",
      ...
      filedDate: result.date_filed || result.filed || "",
      snippet,
    },
