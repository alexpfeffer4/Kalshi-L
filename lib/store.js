...
import {
  ...
  getEventLocal,
  listEventAuditLogsLocal,
  listIngestionRunsLocal,
  listEventsLocal,
  recordEventAuditLogLocal,
...
import {
  ...
  getEventSupabase,
  listEventAuditLogsSupabase,
  listIngestionRunsSupabase,
  listEventsSupabase,
  recordEventAuditLogSupabase,
...
export async function recordEventAuditLog(entry) {
  return useSupabase() ? recordEventAuditLogSupabase(entry) : recordEventAuditLogLocal(entry);
}

export async function listEventAuditLogs(eventId) {
  return useSupabase() ? listEventAuditLogsSupabase(eventId) : listEventAuditLogsLocal(eventId);
}
